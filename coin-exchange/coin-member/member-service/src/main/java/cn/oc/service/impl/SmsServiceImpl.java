...
public class SmsServiceImpl extends ServiceImpl<SmsMapper, Sms> implements SmsService {
    ...
    @Override
    public SendSmsResponse sendSmsRequest(SendSmsRequest request) {
    ...
    private SendSmsRequest buildSmsRequest(Sms sms) {
        ...
        NacosConfigProperties.Config signConfig = configService.getConfigByCode("SIGN");
        ...
        NacosConfigProperties.Config configByCode = configService.getConfigByCode(sms.getTemplateCode());
